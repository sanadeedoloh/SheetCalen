...
const App: React.FC = () => {
  ...
  const triggerOneHourAdvanceDemo = () => {
    ...
    triggerAlert("เริ่มจำลองแจ้งเตือนล่วงหน้า 1 ชั่วโมง: จะส่งเข้าเครื่องใน 2 วินาที...", "success");
    setTimeout(() => {
      showSystemNotification(
              ...
              <div className="p-5 sm:p-6 bg-slate-50 overflow-y-auto max-h-[60vh] sm:max-h-[65vh] space-y-5 scrollbar-thin">
                ...
                <div className="bg-white rounded-2xl p-4 sm:p-5 border border-orange-500/20 shadow-sm space-y-3.5 bg-orange-600/5">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    ...
                    >
                      ⚡️ จำลองพุชแจ้งเตือน (TEST BANNER)
                    </button>
                    <button
                      onClick={triggerOneHourAdvanceDemo}
                      className="flex-1 py-2.5 bg-orange-600 hover:bg-orange-550 text-white rounded-xl text-[10px] font-black tracking-widest uppercase transition-all shadow cursor-pointer text-center"
                    >
                      ⏰ จำลองแจ้งเตือนล่วงหน้า 1 ชม.
                    </button>
                  </div>
                </div>
